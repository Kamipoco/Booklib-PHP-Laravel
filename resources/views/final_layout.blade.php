...
<nav class="navbar navbar-light navbar-expand-md" style="background-color: #06623b;height: 30px;padding: 0px;">
    <div class="container-fluid">
        <div style="padding: 0px;">
            <a href="{{route('home')}}" style="color: rgb(255,255,255);font-size: 12px;padding: 7px 10px;">Trang Chủ</a>
            <a href="{{route('get.introduction')}}" style="color: rgb(255,255,255);font-size: 12px;padding: 7px 10px;">Giới thiệu</a>
            <a href="{{route('get.contact')}}" style="color: rgb(255,255,255);font-size: 12px;padding: 7px 10px;">Liên hệ</a>
        </div>
        <div style="padding: 0px;">
            @if(Auth::check())
...
<nav class="navbar navbar-light navbar-expand-md navigation-clean-search" style="background-color: t;">
    <div class="container">
        <a class="navbar-brand" style="letter-spacing: 5px;font-size: 25px;color: #21bf73;" href="{{route('home')}}">BookLib</a>
            ...
            <div class="shadow-none content" style="background-color: rgba(255,255,255,0);">
                <div class="row no-gutters">
                    <div class="col-md-12 col-lg-4 col-xl-3">
                        <div class="summary" style="padding: 8px 0px;margin-right: 5px;padding-right: 10px;padding-left: 10px;">
                            <h3>Danh Mục</h3>
                            <hr>
                            @foreach($cate_product as $key => $cate_p)
                            <div class="dropright border rounded d-flex justify-content-center align-items-center"><button class="btn dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button" style="margin-top: 0px;padding-top: 10px;max-width: 100%;width: 100%;">{{$cate_p->category_tl}}&nbsp;</button>
                                <div class="dropdown-menu" role="menu">
                                    <a class="dropdown-item" role="presentation" href="{{URL::to('/the-loai',$cate_p->category_id)}}">{{$cate_p->category_tl}}</a>
                                </div>
                            </div>
                            @endforeach
                        </div>
                    ...
                    <div class="col-md-12 col-lg-8 col-xl-9" style="background-color: rgba(255,255,255,0);padding: 0px;">
                        <div class="d-flex flex-row items" id="luachon" style="padding: 10px 5px;background-color: #ffffff;margin-bottom: 10px;padding-right: 0px;padding-left: 0px;">
                            <div class="d-flex justify-content-center align-items-center justify-content-xl-center col-sm-9" style="padding: 0px 25px;">
                                <div></div>
                            </div>
                            <div class="d-flex justify-content-center align-items-center col-sm-3">
                                ...
                                <div class="dropdown">
                                    <ul>
                                        <li>
                                            <a href="{{route('fill', 'default')}}">Mặc định</a>
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <li><a class="dropdown-item" href="{{route('fill', 'up')}}">Giá tăng dần</a></li>
                                                <li><a class="dropdown-item" href="{{route('fill', 'down')}}">Giá giảm dần</a></li>
                                                <li><a class="dropdown-item" href="{{route('fill', 'new')}}">Sản phẩm mới nhất</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{route('fill', 'default')}}">Mặc định</a>
                                            <a class="dropdown-item" href="{{route('fill', 'up')}}">Giá tăng dần</a>
                                            <a class="dropdown-item" href="{{route('fill', 'down')}}">Giá giảm dần</a>
                                            <a class="dropdown-item" href="{{route('fill', 'new')}}">Sản phẩm mới nhất</a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-content">
                                                <a href="https://quantrimang.com/hoc-css">Mặc định</a>
                                                <a href="https://quantrimang.com/html">Giá tăng dần</a>
                                                <a href="https://quantrimang.com/python">Giá giảm dần</a>
                                                <a href="https://quantrimang.com/python">Sản phẩm mới nhất</a>
                                            </div>
                                        </div>
                                        -->
